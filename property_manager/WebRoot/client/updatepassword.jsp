				...
				<article class="module width_full">
			       <header><h3>修改密码</h3></header>
				    <div class="module_content">
						<fieldset style="width:49%;margin-left: 25%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>原密码：</label>			
							<input type="password" style="width:45%;" name="pwd1">
						</fieldset>
						<div class="clear"></div>
						<fieldset style="width:49%;margin-left: 25%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>新密码：</label>			
							<input type="password" style="width:45%;" name="pwd2">
						</fieldset>
						<div class="clear"></div>
						<fieldset style="width:49%;margin-left: 25%;"> <!-- to make two field float next to one another, adjust values accordingly -->
							<label>重复新密码：</label>			
							<input type="password" style="width:45%;" name="pwd3">
							<input type="hidden" name="id" value="${userinfo.id}">
						</fieldset>
						<div class="clear"></div>	
						<div class="submit_link">
					<input type="submit" value="确认" class="alt_btn">
				</div>		
				</div>								
